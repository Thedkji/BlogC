     ...
     <div class="container">
         <div class="row">
             <div class="col-lg-9 mx-auto">
                 <h2 class="mb-5">TRẢI NGHIỆM <br> TIN TỨC MỚI MỖI NGÀY </h2>
                 <ul class="list-inline widget-list-inline">
                     @foreach ($dataTag->take(15) as $tag)
                         <li class="list-inline-item"><a href="{{ route('client.postDetail',$tag->id) }}">{{ $tag->tag_name }}</a></li>
                     @endforeach
                 </ul>
             </div>
         </div>
